  ...
  return (
    ...
    >
      ...
      <section>
        ...
        {/* ======= MENU ITEMS ======= */}
        <div className="flex flex-col mt-7 mx-2">
          <SidebarMenuItem
          ...
          <div className="relative group">
            ...
            <div
              ...
              className={`flex items-center px-3 h-[50px] rounded-lg transition-all duration-200
                hover:bg-blue-950 hover:text-white overflow-hidden
                ${isCollapsed ? "justify-center" : "justify-start"}
        `}
            >
              <GiCheckMark className={`${isCollapsed ? "mx-auto" : "mr-4"}`} />
              {!isCollapsed && (
                <>
            ...
            {isCollapsed && (
              <div className="absolute top-0 z-50 hidden p-2 bg-white border border-gray-200 rounded-lg shadow-lg left-full w-52 group-hover:block">
                <SidebarMenuItem
                  isCollapsed={false}
                  text="Post a Vehicle"
                  to="/admin/truevalue/post-vehicle"
