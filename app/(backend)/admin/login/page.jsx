        ...
        >
          <div className='mb-8 text-center'>
            <Image
              ...
              width={120}
              height={120}
              className='mx-auto mb-6 bg-white drop-shadow-xl rounded-2xl'
            />
          ...
          <div className='mt-10 text-xs text-center text-gray-400'>
            © {new Date().getFullYear()} Nivya Automobiles <br />
            Developed by{' '}
            <Link
              href='https://www.broaddcast.com'
              target='_blank'
              rel='noopener noreferrer'
              className='text-[#6dd3b6] hover:underline hover:text-[#5cc2a4]'
            >
              Broaddcast Digital
            </Link>
          </div>
